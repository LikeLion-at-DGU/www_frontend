  ...
  return (
    <CardWrapper>
      <CardBorder>
        ...
        <CardText>{record_cards.where}</CardText>
        {/* <CardText>포케 올 데이 잠실점</CardText> */}
      </CardBorder>
      <CardBorder>
        <CardWWW>WHAT: &nbsp; </CardWWW>
        <CardText>{record_cards.what}</CardText>
        {/* <CardText>포케를 먹을 수 있는 식당</CardText> */}
      </CardBorder>
      <CardBorder>
        <CardWWW>HOW(TIPS!): &nbsp; </CardWWW>
        <CardText>{record_cards.how}</CardText>
        {/* <CardText>연어 먹고싶다 리뷰이벤트도 된다 무료로 받으세요</CardText> */}
      </CardBorder>
      <ImgCardBorder>
        <CardImg src={record_cards.card_photo_1} alt="post img1" />
        {record_cards.card_photo_2 && (
          <CardImg src={record_cards.card_photo_2} alt="post img2" />
        )}
        {record_cards.card_photo_3 && (
          <CardImg src={record_cards.card_photo_3} alt="post img3" />
        )}
      </ImgCardBorder>
      <CardInfo>
        <Wrapper>
          <PenImg src={PenIMG} alt="pen" />
          <TagName>{record_cards.tag}</TagName>
        </Wrapper>
        <BookMark />
      </CardInfo>
    </CardWrapper>
